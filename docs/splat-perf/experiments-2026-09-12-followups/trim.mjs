...
P.buildGSplatDrawCommand=function(p){p._updateMemoryStatistics();const r=build.apply(this,arguments);p.trimScratchBuffers();p._updateMemoryStatistics();return r;};
})();`;
